...
// CAPTURAR DATOS
 ...
 $sql  = "SELECT * FROM productos,categorias,moneda WHERE idCat=$idC ";
 ...
 if ($idC==1) {
      ...
      $catP = "Productos Químicos";
    } if ($idC==2) {
  
      $catP = "Cloradores Salinos";
    } if ($idC==3) {
...
<html>
 ...
 <style type="text/css">
   body {
    ...
    <?php
   echo "<title>Pool Store - $catP</title>";
 ?>
...
<?php      
   ...
   echo "<h1><img src='imagenes/logo4.png' width='45 px' height='40 px' /> $catP</h1></div>\n";   
   echo "</div>\n";
 ...
 $imagenP       = utf8_encode($producto["imagenProducto"]); 
    ...
    echo "\t\t\t<img src='$imagenP' width='180px' height='180px' alt='$nombreP'/>\n";
    echo "\t\t\t</a>\n";
    echo "</div>\n";
    echo "<div class='col-md-8'>\n";
    echo "<div class='row'>\n";
    echo "\t<div class='col-md-8'>\n";
    echo "<a href='iProducto.php?v=$idP'; title='Ver Descripción'><h3>$nombreP</h3></a>\n";
