...
<html>
 ...
 <style type="text/css">
   ...
   body {
    ...
    <title>Pool Store - Todos los Productos</title>
  ...
  <div class="row">
   ...
   <div class="panel panel-primary">
     <div class="panel-heading">
      <h1><img src="imagenes/logo4.png" width="45 px" height="40 px" /> Todos los Productos</h1></div>
     </div>
<?php      
 ...
 $imagenP       = utf8_encode($producto["imagenProducto"]); 
    ...
    echo "\t\t\t<img src='$imagenP' width='150px' height='150px' alt='$nombreP'/>\n";
    echo "\t\t\t</a>\n";
    echo "</div>\n";
    ...
    echo "\t\t\t<button class='btn btn-success' type='submit'>Agregar al carrito</button>\n";
    echo "\t\t</div>\n";
    echo "\t</form>\n";
    echo "\t</div>\n";
    echo "\t</div>\n";
